...
function App() {
    ...
    const RemoveFromCart = (productToRemove) => {
        setCart(
            cart.filter((item) => item !== productToRemove)
        )
    }
                    ...
                    <Row>
                        ...
                        <Col>
                            <div class="card" style={{ width: '360px', padding: '20px', marginLeft: '20px' }}>
                                ...
                                <div class="card.body">
                                    <h3 style={{ fontFamily: 'fantasy', fontSize: '18.5px' }} class="card-title"> Cart Summary</h3>
                                    <p style={{ fontFamily: 'fantasy', fontSize: '18.5px' }} class="card.text">Total(item)</p>
                                    <Button style={{ alignSelf: 'end' }} variant="btn btn-primary" size="md" >Proceed To CheckOut</Button>
                                </div>
                            </div>
    ...
    return (
        <div className="App" style={{ backgroundColor: '#F8F8F8' }}>
            <nav style={{ padding: '10px' }} class="navbar  navbar-expand-lg navbar-dark bg-dark justify-content-between" >
                <a onClick={() => setPage('products')} style={{ padding: '10px', fontSize: '30px',fontFamily:'fantasy' }} class="navbar-brand"> DevCoffee Bean Store</a>
